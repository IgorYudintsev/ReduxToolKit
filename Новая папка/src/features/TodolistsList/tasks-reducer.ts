...
// new thunks
export const fetchTasksTC = createAsyncThunk('tasks/fethTasks', async(todolistId: string, thunkAPI) => {
...
export const removeTaskTC = createAsyncThunk('tasks/removeTask', async(param:{todolistId: string,taskId:string}, thunkAPI) => {
    let res= await todolistsAPI.deleteTask(param.todolistId, param.taskId)
